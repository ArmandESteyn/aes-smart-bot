...
var settings = {
   authority: 'https://account-dev.fivefriday.com/',
   client_id: 'SaluteJS',
   redirect_uri: 'http://localhost:3000/oidc-client-sample.html',
   post_logout_redirect_uri: 'http://localhost:3000/oidc-client-sample.html',
   response_type: 'id_token token',
   scope: 'openid profile Salute',
   acr_values: 'tenant:salute',
